...
const Header = ({isOpen,onToggleOpen}) => {
  return (
    ...
    <SignUpModal/>
    <LoginModal/>
    <header className={`header-area style-1 dashboard-header ${isOpen?"slide":""}`}>
          ...
          <ul className="sub-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li><Link legacyBehavior href="/poperty-deatils2"><a>Property Details 02</a></Link></li> 
              </ul>
            </li>
            <li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li><Link legacyBehavior href="/property-map/right"><a>Property Map Right</a></Link></li>
                <li><Link legacyBehavior href="/property/top"><a>Property Map Top</a></Link></li>
              </ul>
            </li>
    ...
    <div className="nav-right d-flex jsutify-content-end align-items-center">   
      ...
      <div className={`sidebar-button mobile-menu-btn ${isOpen? "active":""}`} onClick={onToggleOpen}>
        <span />
      </div>
    </div>
    </header>
