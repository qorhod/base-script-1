...
const Home4Header = () => {
  ...
  return (
    ...
    <div className={`sidebar-menu ${state.isLeftSidebarOpen? "show-menu":""}`}>
      ...
      <ul className="menu-list">
          ...
          <ul className={`sub-menu ${ state.activeMenu === "home-one" ? "d-block" : ""}`}>
              ...
              <li className={currentRoute.startsWith("/index4")?"active":""}><Link legacyBehavior href="/index4"><a>Home 04</a></Link></li>
    ...
    <header ref={headerRef} className={`header-area style-4 ${state.scrollY > 10 ?"sticky":""}`} >
    ...
    <div className="main-menu">
      ...
      <ul className="menu-list">
        <li><Link legacyBehavior href="/property-list"><a>Newly Listed Home</a></Link></li>
        <li><Link legacyBehavior href="/property-list"><a>Lowest Price</a></Link></li>
    ...
    <div className="nav-right d-xl-flex d-none jsutify-content-end align-items-center">
      <div className="header-right">
        <ul>
          ...
          <li>
          <a className="modal-btn header-user-btn d-lg-flex d-none" data-bs-toggle="modal" data-bs-target="#logInModal01">
