...
const HOme4FeatureProperty = () => {
  ...
  return (
    <div className="home4-featured-project-section mb-100 pt-90 pb-90">
    ...
    <div className="row mb-50 wow fadeInUp" data-wow-delay="200ms">
      <div className="col-lg-12 d-flex align-items-end justify-content-between gap-3 flex-wrap">
        ...
        <div className="explore-more-btn">
          <Link legacyBehavior href="/property-list/left-sidebar"><a>Explore More <i className="bi bi-arrow-right" /></a></Link>
        </div>
      </div>
    </div>
    <div className="row">
...
export default HOme4FeatureProperty
