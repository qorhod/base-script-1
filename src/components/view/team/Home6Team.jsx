      ...
      <div className="container">
        <div className="row mb-50 wow fadeInUp" data-wow-delay="200ms">
          <div className="col-lg-12 d-flex align-items-end justify-content-between gap-3 flex-wrap">
            ...
            <div className="slider-btn-group2 dark width-90">
        ...
        <div className="row">
          <div className="col-lg-12">
            <Swiper {...slideSetting} className="swiper home1-team-slider">
              <div className="swiper-wrapper">
                <SwiperSlide className="swiper-slide">
                  <div className="single-team-card style-3">
                    <div className="team-img">
                      <img src="/assets/img/home6/team-img-01.png" alt="" />
                    </div>
                    <div className="team-content">
                      ...
                      <div className="social-area">
                        <ul className="social-icons">
                          ...
                          <li><a href="https://twitter.com/"><i className="bx bxl-twitter" /></a>
                          </li>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="single-team-card style-3">
                    <div className="team-img">
                      <img src="/assets/img/home6/team-img-02.png" alt="" />
                    </div>
                    <div className="team-content">
                      <div className="author-area">
                        <h6>Daniel Scoot</h6>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="single-team-card style-3">
                    <div className="team-img">
                      <img src="/assets/img/home6/team-img-03.png" alt="" />
                    </div>
                    <div className="team-content">
                      <div className="author-area">
                        <h6>Juliyet Marko</h6>
