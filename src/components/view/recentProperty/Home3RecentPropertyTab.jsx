...
const Home3RecentPropertyTab = () => {
  ...
  return (
    <div className="home3-recent-launched-section mb-100">
                    ...
                    <Swiper {...slideSetting} className="swiper brand-category-slider">
                      <div className="swiper-wrapper">
                        <SwiperSlide className="swiper-slide">
                          <div className="product-card3 style-2">
                              ...
                              <div className="swiper product-img-slider">
                                <div className="swiper-wrapper">
                                  <div className="swiper-slide">
                                    <img src="/assets/img/home3/rlc-01.png" alt="image" />
                                  </div>
                                  <div className="swiper-slide">
                                    <img src="/assets/img/home3/rlc-02.png" alt="image" />
                                  </div>
                                  <div className="swiper-slide">
                                    <img src="/assets/img/home3/rlc-03.png" alt="image" />
                                  </div>
                                  <div className="swiper-slide">
                                    <img src="/assets/img/home3/rlc-04.png" alt="image" />
                                  </div>
                                </div>
                              </div>
                            </div>
                        ...
                        <SwiperSlide className="swiper-slide">
                          <div className="product-card3 style-2">
                            ...
                            <div className="product-content">
                              ...
                              <h5><Link legacyBehavior href="/property-list/deatils1"><a>Radiant Roofs Real Estate</a></Link></h5>
                              <ul className="features">
                                <li>
                                  <img src="/assets/img/home1/icon/bed2.svg" alt="" />
                                  04 Beds
                        ...
                        <SwiperSlide className="swiper-slide">
                          <div className="product-card3 style-2">
                            ...
                            <div className="product-content">
                              ...
                              <h5><Link legacyBehavior href="/property-list/deatils1"><a>Equinox Properties</a></Link></h5>
                              <ul className="features">
                                <li>
                                  <img src="/assets/img/home1/icon/bed2.svg" alt="" />
                                  04 Beds
...
export default Home3RecentPropertyTab
