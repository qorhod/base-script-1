...
const Home4RecentProperty = () => {
  ...
  return (
    <div className="home4-recent-project-area mb-100">
        ...
        <div className="col-lg-12 d-flex align-items-end justify-content-between gap-3 flex-wrap">
          ...
          <div className="tab-and-slider-btn-group">
            <ul className="nav nav-tabs" id="myTab5" role="tablist">
              ...
              <li className="nav-item" role="presentation">
                <button className="nav-link" id="suv-tab" data-bs-toggle="tab" data-bs-target="#suv" type="button" role="tab" aria-controls="suv" aria-selected="false" tabIndex={-1}>For Sale</button>
              </li>
              <li className="nav-item" role="presentation">
                <button className="nav-link" id="toyota-tab" data-bs-toggle="tab" data-bs-target="#toyota" type="button" role="tab" aria-controls="toyota" aria-selected="false" tabIndex={-1}>For Rent</button>
              </li>
            </ul>
...
export default Home4RecentProperty
