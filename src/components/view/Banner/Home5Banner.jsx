"use client";
import MapIcon from "@mui/icons-material/Map"; // استيراد أيقونة الخريطة
...
const Home5Banner = () => {
  ...
  const images = userData?.user?.homepage?.images || [];
      ...
      {images.map((imgUrl, idx) => (
        <SwiperSlide key={idx} className="swiper-slide">
          <div
            className="banner-bg"
            style={{
              backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.30), rgba(0, 0, 0, 0.30)), url(${imgUrl})`,
            }}
          >
          </div>
        </SwiperSlide>
        ...
        {/* <SwiperSlide className="swiper-slide">
          <div className="banner-bg" style={{backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.30), rgba(0, 0, 0, 0.30)), url(/assets/img/home5/home5-banner-img-01.png)'}}>
          </div>
        </SwiperSlide>
        <SwiperSlide className="swiper-slide">
          <div className="banner-bg" style={{backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.30), rgba(0, 0, 0, 0.30)), url(/assets/img/home5/home5-banner-img-02.png)'}}>
          </div>
        </SwiperSlide>
        <SwiperSlide className="swiper-slide">
          <div className="banner-bg" style={{backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.30), rgba(0, 0, 0, 0.30)), url(/assets/img/home5/home5-banner-img-03.png)'}}>
          </div>
        </SwiperSlide> */}
      </div>
    </Swiper>
      ...
      <div className="row">
        <div className="col-lg-12">
          <div className="banner-content">
            <h1> {userData?.user?.homepage?.marketingTitle || ""}</h1>
            <p>{userData?.user?.homepage?.marketingPhrase || ""}</p>
            <div className="banner-content-bottom">
              <div className="view-dt-btn">
              <Link legacyBehavior href={`/property-list`} >
              <a  className="primary-btn3">
                    <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18">
                      <mask id="mask0_485_1352" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x={0} y={0} width={18} height={18}>
                        <rect width={18} height={18} fill="#D9D9D9" />
                      </mask>
                      <g mask="url(#mask0_485_1352)">
