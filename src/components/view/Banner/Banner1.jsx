...
const Banner1 = () => {
  ...
  return (
    <div className="banner-section1">
      <Swiper {...slideSetting} className="swiper home1-banner-slider">
        <div className="swiper-wrapper">
          <SwiperSlide className="swiper-slide">
            <div className="container-fluid">
              <div className="row g-xl-4 gy-5">
                <div
                  className="col-lg-7 d-flex align-items-center wow fadeInUp"
                  data-wow-delay="200ms"
                >
                  <div className="banner-content">
                    <h6>
                      <span>01</span> On Going Property
                    </h6>
                    <h1>Nimbus Properties</h1>
                    <p>
                      {" "}
                      To help neckle company stand out and make an impression on
                      potential.
                    </p>
                    <div className="banner-content-bottom">
                      <div className="view-dt-btn">
                        <Link legacyBehavior
                          href="/property-list/deatils1"
                ...
                <div className="col-lg-5">
                  <div className="banner-img-area">
                    <img src="/assets/img/home1/banner-img-01.png" alt="" />
                    <div className="price-and-features-area">
                      ...
                      <ul className="features">
                        <li>
                          <img src="/assets/img/home1/icon/bed.svg" alt="" />
                          06 Beds
                        </li>
                        <li>
                          <img src="/assets/img/home1/icon/bath.svg" alt="" />
                          03 Baths
                        </li>
                        <li>
                          <img src="/assets/img/home1/icon/size.svg" alt="" />
                          Sq.ft- 453,234
                        </li>
                      </ul>
                    </div>
            ...
            <div className="container-fluid">
              <div className="row g-xl-4 gy-5">
                ...
                >
                  <div className="banner-content">
                    <h6>
                      <span>02</span> Complite Property
                    </h6>
                    <h2>Harmony House</h2>
                    <p>
                      {" "}
                ...
                <div className="col-lg-5">
                  <div className="banner-img-area">
                    <img src="/assets/img/home1/banner-img-02.png" alt="" />
                    <div className="price-and-features-area">
                      <div className="price-and-location">
                        <div className="price">
                          <strong>$8,656.00</strong>
                        </div>
                        <div className="location">
            ...
            <div className="container-fluid">
              <div className="row g-xl-4 gy-5">
                ...
                >
                  <div className="banner-content">
                    <h6>
                      <span>02</span> Up Comming Property
                    </h6>
                    <h2>Sunflower Cottage</h2>
                    <p>
                      {" "}
                      To help neckle company stand out and make an impression on
                      potential.
                ...
                <div className="col-lg-5">
                  <div className="banner-img-area">
                    <img src="/assets/img/home1/banner-img-03.png" alt="" />
                    <div className="price-and-features-area">
                      <div className="price-and-location">
                        <div className="price">
                          <strong>$5,656.00</strong>
                        </div>
                        <div className="location">
                          <Link legacyBehavior href="/property-list/left-sidebar">
                            <a>
