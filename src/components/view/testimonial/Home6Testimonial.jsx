...
const Home6Testimonial = () => {
  ...
  return (
    <div className="customar-feedback-area style-2 mb-100">
    ...
    <div className="row g-4 mb-100">
      ...
      <div className="col-lg-9 wow fadeInUp" data-wow-delay="200ms">
        <div className="customer-feedback-right">
          <Swiper {...slideSetting} className="swiper customer-feedback-slider mb-40">
            <div className="swiper-wrapper">
              <SwiperSlide className="swiper-slide">
                <div className="feedback-card">
                  ...
                  <p><strong>neckle-Agency</strong> to the actively encourage customers to leave
              ...
              <SwiperSlide className="swiper-slide">
                <div className="feedback-card">
                  ...
                  <p><strong>neckle-Agency</strong> customer feedback is an invaluable source of
