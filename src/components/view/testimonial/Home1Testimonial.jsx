            ...
            <div className="swiper-wrapper">
              <SwiperSlide className="swiper-slide">
                <div className="feedback-card">
                  ...
                  <p>For rental properties, users may provide feedback on the responsiveness of the property management team, maintenance services, and the overall experience.</p>
