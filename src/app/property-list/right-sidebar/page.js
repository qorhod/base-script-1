                ...
                <div className={`list-grid-product-wrap ${!isGridView ?"list":"grid"}-group-wrapper`}>
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                        ...
                        <div className="product-content">
                            ...
                            <Link legacyBehavior href="/property-list"><a><i className="bi bi-geo-alt" />  Sydne City</a></Link>
                            </div>
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="300ms">
                        ...
                        <div className="product-content">
                            <div className="location">
                            <Link legacyBehavior href="/property-list"><a><i className="bi bi-geo-alt" />  Panama City</a></Link>
                            </div>
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                        ...
                        <div className="product-content">
                            <div className="location">
                            <Link legacyBehavior href="/property-list"><a><i className="bi bi-geo-alt" /> Melbourne City</a></Link>
                            </div>
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                        ...
                        <div className="product-content">
                            <div className="location">
                            <Link legacyBehavior href="/property-list"><a><i className="bi bi-geo-alt" /> Menchester City</a></Link>
                            </div>
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                        ...
                        <div className="product-content">
                            <div className="location">
                            <Link legacyBehavior href="/property-list"><a><i className="bi bi-geo-alt" /> New Delhi</a></Link>
                            </div>
                            <h5><Link legacyBehavior href="/property-list/deatils1"><a>Meadowview Manor</a></Link></h5>
                            <ul className="features">
                            <li>
