...
const DashboardProfile = () => {
  ...
  const toggleOldConfirmPasswordVisibility = () => {
  ...
  const handleFileInputChange = (e) => {
    ...
    if (file && file.type.startsWith('image/')) {
      ...
      // Handle non-image files or other cases as needed
    }
  };
        ...
        <div className="col-lg-12">
          <div className="main-content-title-profile mb-50">
            <div className="main-content-title">
              ...
              <img src="/assets/img/dashboard/icon/smile-icon.svg " alt="" />
            </div>
      ...
      <div className="dashboard-profile-wrapper">
        <div className="dashboard-profile-nav">
          <ul className="nav flex-column nav-pills" id="pills-tab" role="tablist">
            ...
            <li className="nav-item" role="presentation">
              <button className="nav-link" id="preference-tab" data-bs-toggle="pill" data-bs-target="#preference" type="button" role="tab" aria-controls="preference" aria-selected="false">
                <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14">
                  <g clipPath="url(#clip0_820_622)">
            ...
            <li className="nav-item" role="presentation">
              <button className="nav-link" id="change-pass-tab" data-bs-toggle="pill" data-bs-target="#change-pass" type="button" role="tab" aria-controls="change-pass" aria-selected="false">
                <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14">
                  <g clipPath="url(#clip0_820_628)">
          ...
          <div className="tab-pane fade show active" id="profile" role="tabpanel">
            <div className="dashboard-profile-tab-content">
              ...
              <form>
                <div className="row">
                  ...
                  <div className="col-md-6 mb-30">
                    <div className="form-inner">
                      <label>Country*</label>
                      <SelectComponent placeholder={"select"} options={["United Kingdom","Bangladesh","United State"]} />
                    </div>
                  </div>
                </div>
                    ...
                    {imgFile && (
                      <div className="upload-img-wrap">
                        <div className="single-img">
                          <div data-file={imgFile.name} className="img-bg">
                            <img src={imgDataUrl} alt={imgFile.name} />
                            <div className="upload-img-close-btn" onClick={removeImage}></div>
                          </div>
                        </div>
                      </div>
                    )}
                      <button type="button" className="upload-btn" onClick={handleImageChange}><i className="bi bi-plus-lg" /></button>
                    </div>
                  </div>
                ...
                <div className="form-inner">
                  <button type="submit" className="primary-btn3">Update Change</button>
                </div>
              </form>
            </div>
          </div>
                ...
                <div className="row g-lg-4 gy-3">
                  <div className="col-md-6">
                    <div className="form-inner">
                      ...
                      <SelectComponent placeholder={"select"} options={["Dollar (USD)","Taka (BDT)"]} />
                  ...
                  <div className="col-md-6">
                    <div className="form-inner">
                      ...
                      <SelectComponent placeholder={"select"} options={["Sq.ft","Cm"]} />
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="form-inner mb-30">
                      ...
                      <input id="password9" type={passwordVisible ? 'text' : 'password'}value={password} onChange={(e) => setPassword(e.target.value)} placeholder="*** ***" />
                  ...
                  <div className="col-md-6">
                    ...
                    <input id="password1" type={oldpasswordVisible ? 'text' : 'password'} value={oldpassword} onChange={(e) => setOldPassword(e.target.value)} placeholder="*** ***" />
                        <i className={`bi bi-${oldpasswordVisible?"eye":"eye-slash"}`}  onClick={toggleOldConfirmPasswordVisibility} id="togglePassword2" />
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="form-inner mb-50">
